...
export default class FilmCard {
  constructor(filmListElement, mainElement, bodyElement, changeData) {
  ...
  init(film, comments) {
    ...
    this._filmPopupPresenter = new FilmPopupPresenter(this._mainElement, this._bodyElement, this._changeData);
